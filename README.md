...
Set up Environment Variables: Create a .env file in src/backend (optional, defaults to Mock Data if missing):
...
Upload a Loan Agreement PDF (e.g., test_loan.pdf).
Wait for the analysis cards to appear.
Project Structure
.
